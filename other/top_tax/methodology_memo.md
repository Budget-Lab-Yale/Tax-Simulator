...
| Long-run response (η) — *realizations scale by exp(−η × change in the tax cost of realizing now versus deferring)* | 2.48 | Calibrated on the full model to our preferred realization elasticity of −0.6 |
...
| Income conversion (σ) — *percent of the eligible compensation pool converted per point of change in the ordinary-versus-deferred-gain wedge* | 0.16 | Residual: set so the total top ETI is 0.25 (Saez, Slemrod, and Giertz 2012) |
