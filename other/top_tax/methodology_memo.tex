...
$C'(r_B) = 0$, so baseline behavior is reproduced exactly. Setting the
...
constant semi-elasticity in the full deferral wedge rather than in the current-year
rate alone.
...
at $\sigma = 0.16$, meaning 0.16 percent of the pool converts per percentage
point of wedge change; a full run at that value confirms it. The calibration
...
For the calibration (July 2026), we ran a permanent increase in the top statutory
...
liability changes across scenarios. Deemed realization is different.
Because it applies to transfers below the estate-tax exemption too, its
burden is spread in proportion to inheritance rather than through the
threshold-driven rank match. The valuation bridge, deductions, gifts,
