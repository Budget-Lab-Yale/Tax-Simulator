...
| **SC** | $15,000/person age-65 deduction, reduced dollar-for-dollar by the retirement deduction claimed (12-6-1170(B)) | Needs the retirement-offset coupling | **Second-largest gap**: ~$700-900/person at 65+ (6-6.2% rates). The existing VA-style `age_ded_*` machinery is close; needs one new coupling (offset by pension exclusion taken) rather than an income test. Recommend encoding. |
