...
| # | Item | Tier | Status |
|---|------|------|--------|
| 1 | Unknown-param silent default | Blocking-class hazard | OPEN |
| 2 | Inert config indistinguishable from modeled | Blocking-class hazard | OPEN |
...
| 7 | Generalize dense-table CSV; retire long YAML vectors | Suggestion | OPEN |
| 8 | Explicit income base per phase-out | Suggestion | OPEN |
