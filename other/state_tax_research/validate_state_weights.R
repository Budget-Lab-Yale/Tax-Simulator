#!/usr/bin/env Rscript
#------------------------------------------------------------------------------
# validate_state_weights.R
#
# Phase 1 §4 comparison harness, part 2: decision-relevant validation of the
# sweep's candidate weight sets (configs 7 and 11 of sweep_state_weights.R,
...
# Reload tu exactly as build_state_weights.R (the row order p$idx indexes),
