#!/usr/bin/env Rscript
#------------------------------------------------------------------------------
# 02_build_residual_anchors.R  (Stage D, nonfiler_residual_design.md §4.2)
#
...
#   Rscript other/state_tax_research/nonfiler_residual/02_build_residual_anchors.R [year]
