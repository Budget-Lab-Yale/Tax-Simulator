#!/usr/bin/env Rscript
#------------------------------------------------------------------------------
# 03_diagnose_current_nonfilers.R  (Stage D, nonfiler_residual_design.md §4.3)
#
# Two modes:
#
...
res_dir <- 'other/state_tax_research/nonfiler_residual/results'
...
# Production Tax-Data vintage (same resolution as build_state_weights.R)
...
# sweep_state_weights.R:67 -- irs.gov EITC Central, ACS-Census linkage)
EITC_TAKEUP <- c(
