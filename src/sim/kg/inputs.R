...
kg_dyn_attach_record_attrs = function(tax_units, cpiu_by_year = NULL) {
  ...
  if (!is.null(cpiu_by_year)) {
    ...
    needed = unique(c(as.character(tax_units$year),
                      as.character(economy_param('kg', 'char_base_year'))))
    ...
    cpiu_base = as.numeric(cpiu_by_year[as.character(economy_param('kg', 'char_base_year'))])
  ...
  p_char_extensive[has_estate] = plogis(
    economy_param('kg', 'char_extensive_intercept') +
      economy_param('kg', 'char_extensive_ln_slope') * log_estate[has_estate]
  )
  p_char_intensive[has_estate] = plogis(
    economy_param('kg', 'char_intensive_intercept') +
      economy_param('kg', 'char_intensive_ln_slope') * log_estate[has_estate]
  )
...
kg_dyn_load_cpiu_levels = function(macro_root, years,
                                   base_year = economy_param('kg', 'char_base_year')) {
