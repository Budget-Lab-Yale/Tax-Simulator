#!/usr/bin/env Rscript
#------------------------------------------------------------------------------
# research/state_weights/scripts/sweep_state_weights.R
#
...
#   Rscript research/state_weights/scripts/sweep_state_weights.R --prior
#       build + cache the shared counts-IPF prior (run once, before the array)
#   Rscript research/state_weights/scripts/sweep_state_weights.R <config_id>
