...
**Companions:** `research/state_weights/nonfiler_residual_design.md` (the design this executes),
`research/state_weights/state_weights_phase1_summary.md` (weights bake-off the rework feeds).
...
1. ~~**SSA manual downloads** (ssa.gov blocks the cluster).~~ **CLOSED
   ...
   **more years than the anchors need** — OASDI 2017–2025 (9 workbooks plus the
   ...
   Still to do (task A1 in `research/state_weights/plan.md`): write the two readers,
