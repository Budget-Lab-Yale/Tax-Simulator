...
Reconstructed from the code, `research/state_tax/state_parameter_workflow.md`, and the source packets:

1. **Research**: primary DOR forms -> source packet (`research/source_packets/{st}.md`),
...
- CT research-record preservation (`research/raw/ct_research_*.md`, hash-verified
...
| 9 | Coverage + continuity test layers; start cross-model | Suggestion | RESOLVED 2026-08-11 (cross-model harness built 2026-07-18; coverage layer = smoke-active credit families must be exercised by a worksheet case, found+filled IL st_ctc / NY st_cdctc / WI st_cdctc; continuity = $500-step AGI sweep with per-state documented cliff allowances, 601 pts x 24 states x 2 years; NH/TN/WA added to the smoke grid) |
