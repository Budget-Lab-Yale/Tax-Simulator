...
`research/raw/va_research_core.md` (rates, standard deduction, itemization/Pease,
exemptions, thresholds, conformity, filing statuses) and
`research/raw/va_research_mods_credits.md` (age deduction, SS/refund/UI/US-obligation
