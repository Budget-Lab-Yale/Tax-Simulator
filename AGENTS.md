...
**Detailed override rules, common mistakes, and examples are in the `/policy-config` skill** (`.Codex/skills/policy-config/SKILL.md`).
...
separate shell invocations (and each Codex Bash tool call is a fresh shell):
